...
public interface PRPIDao {
	...
	List<PRPData> pRPgetprDetailsByPrpId(Integer pr_Id);
	...
	List<PRPData> pRpSearchByCondition(String pRpId, String supplierName, String approver1Status,
	...
	String getPRNumberByPrId(Integer pRpPRId);
