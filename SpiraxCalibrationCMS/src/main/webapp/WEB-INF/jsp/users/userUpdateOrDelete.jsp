...
<body>
	...
	<div class="container-fluid">
		...
		<span><a href=""><h id="hrefCss">${addOrUpdate}</h></a></span> <br> <br>
				...
				<div class="col-sm-4">
					<div class="form-group">
						...
						<form:input path="useUserName" id="username" class="form-control"
							placeholder="Enter User Name.." onchange="userNameChange();" autocomplete="off"/>
						<div>
			...
			<div class="row" align="left" id="searchboxCss">
				...
				<div class="col-sm-4">
					<div class="form-group">
						...
						<form:select id="userDept" class="form-control" name="userDept"
							style="height: 35px;" path="userDepartment">
							<c:forEach items="${userDepartmentList}" var="userDept">
								<c:choose>
									<c:when test="${userData.userDepartment == userDept}">
										<option value="${userData.userDepartment}" selected>${userData.userDepartment}</option>
									</c:when>
									<c:otherwise>
				...
				<div class="col-sm-4">
					<div class="form-group">
						...
						<form:select id="userrole" class="form-control" name="userrole"
							...
							<c:forEach items="${userRolesLookUp}" var="userRole">
								<c:choose>
				...
				<div class="col-sm-4">
					<div class="form-group">
						...
						<form:input path="userEmailAddress" id="emailname"
							...
							onchange="userEmailChange();" autocomplete="off"/>
						<div>
				...
				<div class="col-sm-4">
					<div class="form-group">
						...
						<form:input path="userPassWord" placeholder="Enter Password.."
							...
							type="password" onchange="check();" autocomplete="off"/>
						<div>
